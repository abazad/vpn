...
$operator_user = $dbSocket->escapeSimple($_POST['email']);
$operator_pass = $dbSocket->escapeSimple($_POST['password']);

// check if the user id and password combination exist in database
$sql = "SELECT id, username FROM ".$configValues['CONFIG_DB_TBL_DALOOPERATORS']." WHERE email1 = '".
